...
function landingPage(body, data, res){
    ...
    (async () => {
        ...
        try {
            ...
            var go_cart_url = cart_ranshell;
            if(landing_page_url.indexOf("newmo") != -1){
                go_cart_url = cart_newmo;
            }
            await page.goto(go_cart_url, {waitUntil: 'load'});
                            ...
                            if (result) {
                                ...
                                if(result.status_order == "order"){
                                    ...
                                    if (await page.$(btn_order) !== null) {
                                        console.log('===start_click_confirm===', data.product_code);
