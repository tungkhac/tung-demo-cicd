...
const fs      = require('fs');
var container = config.get('azure_storage_matchwatch_container');
var blobServiceImage = azure.createBlobService(config.get('azure_connectstring'));
const AZURE_STORAGE_URL = 'https://' + config.get('azure_storage_name') + '.blob.core.windows.net/' + config.get('azure_storage_matchwatch_container');
var emailValidator = require("email-validator");

const currencyFormatter = require('currency-formatter');

const user_app_id = 9;
const user_app_token = "YeECeZjtRtDkTpiyjEQrwpRc1OkfGIyCqZ3tm7cc";
const model_app_id = 14;
const model_app_token = "9mLANofRh6R7X8ynHsmsC5D10BOcSvjLQjuwpEgr";
const profile_app_id = 15;
const profile_app_token = "GVUJjRURn9fQQ2wVpdkYGvUAfvfpbVv2883XDj8g";
const favorite_app_id = 19;
const favorite_app_token = "YFJLB9WblWCP18EFFM2VYdgOcsuzoQkkBRkTY6Pq";

const brand_app_id = 13;
const brand_app_token = "UmZ8MOluzrdb9nqXGwUYclXxrh2nNvkpLx9XgfiK";

const watch_state_app_id = 16;
const watch_state_app_token = "1fvpJdSMvXHVnQlfAhv0VbcjC6s9eE55SF8N4vWp";

const rent_app_id = 17;
const rent_app_token = "a7yDXkJafXvqGOertm5JCzBnpg7olsrxWBaX3eBM";

const borrower_insurance_app_id = 10;
const borrower_insurance_app_token = "I5GmwJuGNmiAvf4ZDot7yGG6y8tXFtIE7QhPL3Ij";

const auth_log_app_id = 11;
const auth_log_app_token = "xfu72tI2UuOAHB3eaWKQn8sFpgaG409ij7o1xnwm";

const preference_app_id = 23;
const preference_app_token = "ZEcSMmAoIwoTgHxf4uhDaNB6zfpYf5RE875hK6dL";

const point_app_id = 12;
const point_app_token = "HlhPmMsuX2qjkh1zaWYUzDYzuYiG9dFkRWOoL8w2";

const queue_app_id = 57;
const queue_app_token = "ZDKzYKRkvo1XZmE3fTreKOPZsICjGYWvsZDXaKWj";

const bot_id = "5d31cd15a24a61078d5606f4";
//const bot_id = "5ac2d9519a8920796d40004a";
const line_access_token = "xULOk0u0YLdotNBVFOprmkoXM0UABqFEUKYvdZ7ON+5pZLjMlpNPIpqOuRNaspX2ogU3spBl2PrYwL8IAA8/EaY6COl+TeGlr5CT+g2LzR3xIdKX23XiHIjN1LQmtPELwPNSqAX2+RG2bwEXtNfOEQdB04t89/1O/w1cDnyilFU=";

//const line_access_token = "2EYVEjQDWJdAWPiXFaCsQ1AfOJ7BRk0YvKBm70B/w1cCvWiZSCv55IypDf5NmgJ2QoZF4q7/i2saS+fW5VChG3Go2XPRsOk312Qzoymc0ky6uHosdk9/0vtcgtvRfyret2iIoOS8VbZReh/7QdOCJAdB04t89/1O/w1cDnyilFU=";
...
const api_new_list_url = "https://appdev01.matchwatch.jp/api/v1/new_list";
                            ...
                            getWatchState(WatchIDArr, function (stateArr) {
                                getWatchModel(ModelIDArr, function (modelArr) {
                                    ...
                                    Object.keys(profileArr).forEach(function(WatchID) {
                                        ...
                                        column.thumbnailImageUrl = tmp.CoverPicture1_azure_link;
